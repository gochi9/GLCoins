...
import com.deadshotmdf.gLCoins_Server.events.economy.*;
...
public class EconomyWrapper implements Economy {
    ...
    public void noTaxDepositPlayer(OfflinePlayer player, double amount){
        original.depositPlayer(player, amount);
    }

    @Deprecated
    public EconomyResponse depositPlayer(String s, double amount) {
        PlayerDepositEvent playerDepositEvent = new PlayerDepositEvent(Bukkit.getOfflinePlayer(s), amount, true);
        callEvent(playerDepositEvent);
        EconomyResponse response = original.depositPlayer(Bukkit.getOfflinePlayer(s), playerDepositEvent.getAmount());
        return response;
    }

    public EconomyResponse depositPlayer(OfflinePlayer player, double amount) {
        PlayerDepositEvent playerDepositEvent = new PlayerDepositEvent(player, amount, true);
        callEvent(playerDepositEvent);
        EconomyResponse response = original.depositPlayer(player, playerDepositEvent.getAmount());
        return response;
    }
    ...
    public EconomyResponse depositPlayer(String s, String s1, double amount) {
        PlayerDepositEvent playerDepositEvent = new PlayerDepositEvent(Bukkit.getOfflinePlayer(s), amount, true);
        callEvent(playerDepositEvent);
        EconomyResponse response = original.depositPlayer(Bukkit.getOfflinePlayer(s), s1, playerDepositEvent.getAmount());
        return response;
    }
    ...
    public EconomyResponse depositPlayer(OfflinePlayer player, String s, double amount) {
        PlayerDepositEvent playerDepositEvent = new PlayerDepositEvent(Bukkit.getOfflinePlayer(s), amount, true);
        callEvent(playerDepositEvent);
        EconomyResponse response = original.depositPlayer(player, s, playerDepositEvent.getAmount());
        return response;
    }
